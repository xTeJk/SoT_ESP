...
void cDrawing::Draw()
{
	...
	Line(Process->Size[0] / 2 - crosshair_size, Process->Size[1] / 2, Process->Size[0] / 2 + crosshair_size + 1, Process->Size[1] / 2, D3DCOLOR_XRGB(171, 58, 75));
	Line(Process->Size[0] / 2, Process->Size[1] / 2 - crosshair_size, Process->Size[0] / 2, Process->Size[1] / 2 + crosshair_size + 1, D3DCOLOR_XRGB(171, 58, 75));
